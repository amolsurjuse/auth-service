package com.electrahub.identity.observability;
...
public class TraceMdcFilter extends OncePerRequestFilter {
    ...
    private String spanTraceId(Span span) {
        return span == null || span.isNoop() ? "" : span.context().traceId();
    }

    private String spanId(Span span) {
        return span == null || span.isNoop() ? "" : span.context().spanId();
    }
